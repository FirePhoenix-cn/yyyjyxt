...
@property (nonatomic, strong) NSString *bj_sideface_status;
@property (nonatomic, strong) NSString *bj_verify_status;
@property (nonatomic, strong) NSString *canliveverifytime;
@property (nonatomic, strong) NSString *chargeback_time;
...
@property (nonatomic, strong) NSString *liveverifytime;
...
@property (nonatomic, strong) NSString *phone_activate;
