...
- (void)viewDidLoad
{
    ...
    UIView *camView = [[UIView alloc] initWithFrame:self.view.layer.frame];
    //camView.backgroundColor = [UIColor colorWithHexString:@"#5c5c5c"];
    //CGFloat height = layer.frame.size.width /4 *3;
    UIImageView *img = [[UIImageView alloc] initWithFrame:self.view.layer.frame];
    [img setImage:[UIImage imageNamed:@"came2.png"]];
    [camView.layer addSublayer:img.layer];
    
    [self.view.layer addSublayer:camView.layer];
...
-(void)InitializeCamera{
    ...
    // 创建一个相机
    self.camera = [[LLSimpleCamera alloc] initWithQuality:AVCaptureSessionPresetHigh  position:LLCameraPositionFront];
...
- (void)viewWillLayoutSubviews
{
    ...
    self.flashButton.frame=CGRectMake(CGRectGetMaxX(self.snapButton.frame)+KIphoneSize_Widith(50), CGRectGetMidY(self.snapButton.frame)-KIphoneSize_Widith(22), KIphoneSize_Widith(36), KIphoneSize_Widith(44));
    //self.switchButton.frame=CGRectMake(KScreenwidth-KIphoneSize_Widith(50), KScreenheight-KIphoneSize_Widith(75), KIphoneSize_Widith(45), KIphoneSize_Widith(45));
    self.backButton.frame=CGRectMake(self.snapButton.frame.origin.x-KIphoneSize_Widith(50)-KIphoneSize_Widith(45), CGRectGetMidY(self.snapButton.frame)-KIphoneSize_Widith(22), KIphoneSize_Widith(44), KIphoneSize_Widith(44));
    //self.backButton.frame=CGRectMake(KScreenwidth-10-KIphoneSize_Widith(36), KIphoneSize_Widith(25), KIphoneSize_Widith(36), KIphoneSize_Widith(36));
}
